...
async function recreateDB(){
  // Delete everything
  await Headlight.deleteMany();
  let instance1 = new Headlight({manufacturer:"Ford", max_lumen: 1000, production_year: Date(2002)});
  let instance2 = new Headlight({manufacturer:"BMW", max_lumen: 1200, production_year: Date(2003)});
  let instance3 = new Headlight({manufacturer:"Toyota", max_lumen: 1150, production_year: Date(2001)});
